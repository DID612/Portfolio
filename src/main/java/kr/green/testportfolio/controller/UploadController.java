...
import kr.green.testportfolio.util.MediaUtils;
import kr.green.testportfolio.util.UploadFileUtils;
...
public class UploadController {
	...
	public ResponseEntity<String> uploadAjaxPOST(Model model,MultipartFile uploadfile) throws Exception {
		...
		return new ResponseEntity<>(UploadFileUtils.uploadFile(uploadPath, uploadfile.getOriginalFilename(), uploadfile.getBytes()), HttpStatus.CREATED);
	}
